...
@WebServlet("/admin/orderDetail-management/update")
public class AdminUpdateOrderDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final OrderDetailDAO orderDetailDAO;
	
    public AdminUpdateOrderDetailServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		orderDetail.setId(Integer.parseInt(request.getParameter("id")));
		...
		request.setAttribute("success_messages", new String[] { "Cập nhật chi tiết giỏ hàng thành công" });
